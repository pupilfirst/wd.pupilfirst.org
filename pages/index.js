		...
		<div className={""}>
			...
			<main className="bg-gradient-to-br from-gray-800 to-gray-900 mx-auto">
				...
				>
					<div className="text-white mt-10 w-full md:w-3/5">
						<div className="flex items-center gap-4 -ml-10">
							...
							<h3 className="text-indigo-700">Learner-Centered Classrooms</h3>
						</div>
						<p>
				...
				<SectionWithHeading
					heading={
						<span>
							Curriculum by <br /> Industry Experts
						</span>
					}
				>
					<div>
						<p className="text-white w-3/5 mt-6">
					...
					<div className="md:divide-x divide-gray-700 gap-2 sm:grid sm:grid-cols-2 lg:grid-cols-4 py-12 lg:pb-16">
